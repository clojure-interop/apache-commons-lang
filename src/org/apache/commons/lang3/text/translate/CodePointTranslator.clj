(ns org.apache.commons.lang3.text.translate.CodePointTranslator
  "Deprecated.
...
(defn ->code-point-translator
  "Constructor.

  Deprecated."
  (^CodePointTranslator []
    (new CodePointTranslator )))
...
(defn translate
  ...
  (^Integer [^CodePointTranslator this ^java.lang.CharSequence input ^Integer index ^java.io.Writer out]
    (-> this (.translate input index out)))
  (^Boolean [^CodePointTranslator this ^Integer codepoint ^java.io.Writer out]
